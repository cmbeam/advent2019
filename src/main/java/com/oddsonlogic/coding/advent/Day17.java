...
public class Day17 {
    public static void main(String[] args) {
        ...
        while (!computer.done) {
            ...
            computer.inputs.add(Integer.parseInt(convertToASCII(bFunction)));
            computer.inputs.add(Integer.parseInt(convertToASCII(cFunction)));
            computer.inputs.add(Integer.parseInt(convertToASCII("n\n")));
            int character = computer.compute().intValue();
            if(character == 10){
                row++;
                collumn = 1;
    ...
    static String convertToASCII(String string){
        ...
        for (int i = 0; i <string.length() ; i++) {
            asciiString = asciiString+(int)string.charAt(i);
        }
        return asciiString;
    }
}
